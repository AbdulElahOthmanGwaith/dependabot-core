...
</h1>  Welcome to the public home of Dependabot :dependabot:.
...
Credentials Proxy to more realistically simulate what's happening within
...
You can profile a dry-run by passing the --profile flag when running it, or tag an rspec test with :profile.
...
subject to and must follow GitHub Logos and Usage. Use of GitHub trademarks or logos in modified versions of this project must not
...
Dependabot and dependabot-core started life as Bump and
Bump Core, back when @hmarr and @greysteil were working at
GoCardless.
...
<p>  Publish a new release to RubyGems by running the Gems - Bump Version workflow and following the instructions on the job summary.
